...
Shader "Enviro/EnviroSurfaceShader/Specular" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_1221 = (_DetailIntensity*_Mask_var.r);
                float3 node_498_nrm_base = _NormalMap_var.rgb + float3(0,0,1);
                float3 node_498_nrm_detail = lerp(_NormalClear_var.rgb,_DetailNormal_var.rgb,node_1221) * float3(-1,-1,1);
                ...
                float3 node_431 = lerp((_Albedo_var.rgb*_AlbedoColor.rgb),_DetailAlbedo_var.rgb,node_1221);
                float3 diffuseColor = lerp(node_431,lerp(node_431,_SnowAlbedo_var.rgb,_SnowStrenght),_Mask_var.g);
