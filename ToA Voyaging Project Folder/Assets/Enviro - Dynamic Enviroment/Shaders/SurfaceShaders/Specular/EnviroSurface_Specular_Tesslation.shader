...
Shader "Enviro/EnviroSurfaceShader/Specular_Tesslation" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_516 = (_DetailIntensity*_Mask_var.r);
                float3 node_498_nrm_base = _NormalMap_var.rgb + float3(0,0,1);
                float3 node_498_nrm_detail = lerp(_DetailNormal_var.rgb,_NormalClear_var.rgb,node_516) * float3(-1,-1,1);
                ...
                float3 node_845 = lerp(node_6517,_DetailAlbedo_var.rgb,node_516);
                float3 diffuseColor = lerp(node_845,lerp(node_845,_SnowAlbedo_var.rgb,_SnowStrenght),_Mask_var.g);
