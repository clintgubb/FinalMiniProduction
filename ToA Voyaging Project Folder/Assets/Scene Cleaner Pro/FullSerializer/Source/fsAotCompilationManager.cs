...
using System.Text;
using Devdog.SceneCleanerPro.FullSerializer.Internal;

namespace Devdog.SceneCleanerPro.FullSerializer {
    /// <summary>
    ...
    public class fsAotCompilationManager {
        ...
        private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic) {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace Devdog.UnityCleanupTool.FullSerializer {");
            ...
            sb.AppendLine("}");
            sb.AppendLine();
            sb.AppendLine("namespace Devdog.UnityCleanupTool.FullSerializer.Speedup {");
